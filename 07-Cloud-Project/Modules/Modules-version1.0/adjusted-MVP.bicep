//this bicep file have all required resources to deploy project version 1.0 
// it includes: VMs, Vnets, storageaccount, blob, conatainer, keyvault, managedID,encryptionsets
//vnet module
